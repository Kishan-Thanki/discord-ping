...
func cmdUptime(s *discordgo.Session, m *discordgo.MessageCreate) {
...
func cmdServerInfo(s *discordgo.Session, m *discordgo.MessageCreate) {
	if m.GuildID == "" {
...
func cmdAvatar(s *discordgo.Session, m *discordgo.MessageCreate) {
